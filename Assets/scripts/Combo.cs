...
public class Combo : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // chute rasteiro
        if(Input.GetKeyDown(KeyCode.C) && Script.noChao == true && Script.agxd == true && Script.naolevanta == false && upkick == false && nooRClicks == 0)
        {
        ...
        if(rasteira == false)
        {
            anim.SetBool("rasteira", false);
                ...
                // Chute pra cima
        if(Input.GetKeyDown(KeyCode.C) && Script.noChao == true && Script.olhdup == true && Script.naolevanta == false && Script.agxd == false && rasteira == false && nooUClicks == 0)
        {
